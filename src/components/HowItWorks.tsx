  ...
  const stepsData = [
    {
      ...
      description: "Complete a one-time identity check using secure, private verification. Your personal information never leaves your device or gets stored anywhere.",
      image: "https://images.unsplash.com/photo-1614064641938-3bbee52942c7?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "02",
      title: "Get Your Credit Line",
      description: "Buy a Credit NFT to unlock your borrowing power. Start with basic limits that grow as you prove you're reliable with payments.",
      image: "https://images.unsplash.com/photo-1559526324-4b87b5e36e44?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "03",
      title: "Spend Like Normal",
      description: "Use your credit to buy crypto, trade, or invest. No need to put up collateral first - just spend what you need when you need it.",
      image: "https://images.unsplash.com/photo-1563013544-824ae1b704d3?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "04",
      title: "Build Your Reputation",
      description: "Pay back on time to improve your trust score. Better scores unlock higher credit limits and lower interest rates over time.",
    ...
    <section className="py-12 sm:py-16 lg:py-20 bg-white relative" id="how-it-works" ref={sectionRef}>
      ...
      <div className="section-container">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16 opacity-0 fade-in-stagger">
          <h2 className="section-title mb-3 sm:mb-4">How CLenFi Makes Credit Simple</h2>
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-dark-900/70 to-transparent">
                  <div className="absolute bottom-0 left-0 right-0 p-3 sm:p-4 lg:p-6 text-white">
                    <span className="text-green-400 font-medium mb-2 block">{step.number}</span>
        ...
        <div className="mt-12 sm:mt-16 lg:mt-20 opacity-0 fade-in-stagger px-4 sm:px-0">
          <div className="text-center mb-6 sm:mb-8">
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">
              See CLenFi in Action
            </h3>
            <p className="text-gray-600 max-w-2xl mx-auto text-sm sm:text-base px-4 sm:px-0">
              Watch how CLenFi revolutionizes DeFi credit with our trust-based lending system
            </p>
          </div>
              ...
              >
                ...
                <div className="absolute bottom-4 sm:bottom-6 lg:bottom-8 left-4 sm:left-6 lg:left-8 right-4 sm:right-6 lg:right-8">
                  <div className="text-white">
                    <h4 className="text-lg sm:text-xl font-semibold mb-1 sm:mb-2">CLenFi Demo</h4>
                    <p className="text-white/80 text-xs sm:text-sm">Trust-based DeFi Credit Platform</p>
                  </div>
                </div>
              </div>
            )}
