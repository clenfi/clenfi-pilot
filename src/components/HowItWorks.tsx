...
const HowItWorks = () => {
  ...
  return (
    <section className="py-20 bg-white relative" id="how-it-works" ref={sectionRef}>
      ...
      <div className="absolute -top-20 right-0 w-72 h-72 bg-green-50 rounded-full opacity-60 blur-3xl -z-10"></div>
      ...
      <div className="section-container">
        <div className="text-center mb-16 opacity-0 fade-in-stagger">
          ...
          <h2 className="section-title mb-4">How CLenFi Works</h2>
          <p className="section-subtitle mx-auto">
            Simple steps to get credit without collateral. Build trust, get better rates.
          </p>
        </div>
