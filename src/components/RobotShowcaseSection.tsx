        ...
        <div className="flex flex-col items-center opacity-0 translate-y-10 transition-all duration-1000">
          <div className="mb-12 text-center">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              CLenFi represents the perfect fusion of traditional credit assessment and 
              cutting-edge blockchain technology, designed to seamlessly bridge CeFi and DeFi lending.
            </p>
          </div>
          ...
          <div className="relative w-full max-w-4xl overflow-hidden rounded-3xl shadow-2xl">
            <img 
              ...
              alt="DeFi blockchain network visualization" 
              className="w-full object-cover"
            />
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-8">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-white text-xl font-semibold">Next Generation Lending</h3>
                  <p className="text-white/80">Designed for DeFi integration</p>
                </div>
                <button className="px-6 py-3 bg-green-500 hover:bg-green-600 text-white font-medium rounded-full transition-colors duration-300">
                  Learn More
                </button>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <p className="text-gray-600">Advanced on-chain analytics provide real-time market awareness and risk assessment.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold mb-2">Dynamic Credit Scoring</h4>
              <p className="text-gray-600">Continuously learns from DeFi interactions to improve credit assessment and personalize rates.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <p className="text-gray-600">Engineered for seamless integration across multiple blockchains and DeFi protocols.</p>
            </div>
          </div>
        </div>
      </div>
