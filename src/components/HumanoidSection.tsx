                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full max-w-6xl items-center">
                  <div className="max-w-lg mx-auto lg:mx-0 lg:ml-8">
                    ...
                    <p className="text-white/80 text-lg">
                      Revolutionary identity verification using ZK-proofs of PAN
                      card data, enabling credit assessment without exposing
                  ...
                  <div className="flex justify-center lg:justify-start items-center">
                    <div className="relative ml-0 lg:ml-12">
                      ...
                      <div className="absolute inset-0 pointer-events-none">
                        <div
                          className="absolute top-8 -left-4 w-4 h-4 bg-green-400 rounded-full opacity-70 animate-ping"
                          style={{ animationDelay: "0s" }}
                        ></div>
                        <div
                          className="absolute top-16 -right-6 w-3 h-3 bg-green-300 rounded-full opacity-70 animate-ping"
                          style={{ animationDelay: "0.7s" }}
                        ></div>
                        <div
                          className="absolute bottom-12 -left-3 w-2 h-2 bg-green-500 rounded-full opacity-70 animate-ping"
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center justify-center">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full max-w-6xl items-center">
                  <div className="max-w-lg mx-auto lg:mx-0 lg:ml-8">
                    ...
                    <p className="text-white/80 text-lg">
                      Traditional credit scoring system adapted for DeFi,
                      providing personalized interest rates and credit limits
                      based on verified financial behavior.
                    </p>
                  </div>
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center justify-center">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full max-w-6xl items-center">
                  <div className="max-w-lg mx-auto lg:mx-0 lg:ml-8">
                    <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                      NFT-Based{" "}
                      <span className="text-green-400">Credit Lines</span>
                    </h3>
                    <p className="text-white/80 text-lg">
                      Unique NFT-based credit lines eliminate
                      over-collateralization. Borrow up to your credit limit
