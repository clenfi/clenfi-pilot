...
const ImageShowcaseSection = () => {
  ...
  return (
    <section className="w-full pt-0 pb-8 sm:pb-12 bg-gradient-to-br from-gray-50 to-white" id="showcase">
        ...
        <div 
          ...
          style={{
            ...
            boxShadow: `
              ...
              0 25px 25px -5px rgba(0, 0, 0, 0.05),
              0 10px 10px -5px rgba(0, 0, 0, 0.02),
              0 0 0 1px rgba(0, 0, 0, 0.02),
              20px 20px 60px rgba(34, 197, 94, 0.1),
        ...
        >
          ...
          >
            ...
            <div className="relative z-10">
              ...
              >
                {/* Inner glow effect */}
                <div className="absolute inset-0 bg-gradient-to-t from-green-100/20 to-transparent pointer-events-none"></div>
          ...
          <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 w-3/4 h-6 bg-black/05 rounded-full blur-xl -z-10"></div>
        </div>
      </div>
    </section>
  );
