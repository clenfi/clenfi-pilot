  ...
  return (
    <div 
      ...
      className={cn(
        ...
        "lg:hover:bg-gradient-to-br lg:hover:from-gray-100 lg:hover:to-gray-50",
        "transition-all duration-300"
      )}
      style={{ animationDelay: `${0.1 * index}s` }}
    >
      <div className="rounded-full bg-green-100 w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center text-green-600 mb-4 sm:mb-5">
        {icon}
      </div>
