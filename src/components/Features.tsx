...
const FeatureCard = ({ icon, title, description, index }: FeatureCardProps) => {
  ...
  return (
    ...
    >
      ...
      <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 text-black">{title}</h3>
      <p className="text-black/80 text-sm sm:text-base">{description}</p>
    </div>
  );
};
...
const Features = () => {
  ...
  return (
    <section className="w-full py-10 sm:py-16 bg-transparent" id="features" ref={sectionRef}>
            ...
            <div className="flex items-center gap-4 mb-8 sm:mb-12">
              <div className="flex items-center gap-4">
                <div className="pulse-chip font-bold italic">
                  <span className="inline-flex items-center justify-center w-5 h-5 rounded-full  mr-2">10</span>
                  <span>Features</span>
                </div>
              </div>
